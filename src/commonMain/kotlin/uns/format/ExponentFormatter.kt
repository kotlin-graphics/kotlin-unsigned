...
internal fun scientificFormat(value: Double, width: Int, fractionPartLength: Int = -1): String =
 ...
 */
private fun roundUp(result: StringBuilder,
                    length: Int = result.length,
                    pos: Int = result.length - 1,
                    keepWidth: Boolean = true): Pair<String, Boolean> {
    if (pos < 0) {
