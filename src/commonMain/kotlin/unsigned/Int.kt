...
//
//
//fun Int.toUbyte(): Ubyte = Ubyte(this)
//fun Int.toUshort(): Ushort = Ushort(this)
//fun Int.toUint(): Uint = Uint(this)
//fun Int.toUlong(): Ulong = Ulong(toLong())
//
//fun Int.toBigInt(): BigInteger = BigInteger.fromLong(toLong())
//fun Int.toUBigInt(): BigInteger = BigInteger.fromULong(toULong())
//
//val Int.ub
//    get() = toUbyte()
//val Int.ui
...
//    get() = toUshort()
//
//infix fun Int.udiv(b: Byte) = (toUlong() / b.toUlong()).toInt()
//infix fun Int.urem(b: Byte) = (toUlong() % b.toUlong()).toInt()
...
//
infix fun Int.udiv(b: Int): Int = (toUInt() / b.toUInt()).toInt()
infix fun Int.urem(b: Int): Int = (toUInt() % b.toUInt()).toInt()
infix fun Int.ucmp(b: Int): Int = toUInt().compareTo(b.toUInt())
