...
//
infix fun Short.udiv(b: Short): Short = (toUShort() / b.toUShort()).toShort()
infix fun Short.urem(b: Short): Short = (toUShort() % b.toUShort()).toShort()
infix fun Short.ucmp(b: Short): Int = toUShort().compareTo(b.toUShort())
infix fun Short.ushr(b: Short): Short = (toUShort().toUInt() shr b.toInt()).toShort()
//
