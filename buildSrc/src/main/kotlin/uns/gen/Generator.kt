...
class Generator {
    ...
    val experimentals = HashSet<Experimentals>()
    var disableNameShadowing = false
    var nothingToInline = false
    ...
    fun write(path: String) {
        File(targetDir, "uns/$path.kt").apply {
            parentFile.mkdirs()
    ...
    val operators = listOf("+" to "plus", "-" to "minus", "*" to "times", "/" to "div", "%" to "rem")
    val unsafeOperators = listOf("div", "rem")
    val bitwiseOperators = listOf("and", "or", "xor", "shl", "shr", "inv")
    val unsafeBitwiseOperators = listOf("shr", "inv")
